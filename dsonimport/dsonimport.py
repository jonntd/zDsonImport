...
#    importer.load_scene(path + 'scene small.duf')
#    importer.load_scene(path + 'temp.duf')
#    importer.load_scene(path + 'tmp.duf')
#    importer.load_scene(path + 'environment sphere (with triangles).duf')
#    importer.load_scene(path + 'scene.duf')
#    importer.load_scene(path + 'prop.duf')
#    importer.load_scene(path + 'tg.duf')
    importer.load_scene(path + 'sk.duf')
#    importer.load_scene(path + 'skyler.duf')
#    importer.load_scene(path + 'import bug.duf')
#    importer.load_scene(path + 'victoria.duf')

    importer.env.get_or_load_file('data/DAZ 3D/Genesis 3/Female/Morphs/3D Universe/G3FSkyler/MCM3duSkyler12yo_EyesClosedL.dsf')
    importer.run_import()
